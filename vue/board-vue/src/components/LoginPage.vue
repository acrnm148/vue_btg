<template>
  <div class="container">
    ...
    <div class="mb-3">
      ...
      <input type="email" class="form-control" placeholder="이메일을 입력하세요." v-model="userEmail">
    </div>
    <div class="mb-3">
      <label for="userPassword" class="form-label">Password</label>
      <input type="email" class="form-control" placeholder="비밀번호를 입력하세요." v-model="userPassword">
    </div>
    <div>
...
export default {
    data() {
        return {
            userEmail: "sun@sun.com",
            userPassword: "suna1111!"
        }
    },
    methods: {
        async login() {
